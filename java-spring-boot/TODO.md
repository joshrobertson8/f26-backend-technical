...
Complete the four methods in [src/main/java/com/appteam/events/EventService.java](src/main/java/com/appteam/events/EventService.java). The rest of the app is provided. Events are stored in memory, so no database is needed.
